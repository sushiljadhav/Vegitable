...
<section class="all_products">
	<div class="container">
			<div class="row">
				<div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 product_details_filter">
				...
				<div class="row mb-2 align-items-start">
					...
					<!--Filter Modal -->
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
						<button type="button" class="btn btn-outline-primary btn-sm refine" data-toggle="modal" data-target="#exampleModal">
 						 	Refine
					</button>
					<!-- Modal -->
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="exampleModalLabel">Refine</h5>
									<button type="button" class="btn btn-outline-primary btn-sm" data-dismiss="modal">Done</button>
								...
								<div class="modal-body">
									<div class="product_details_filter">
										<div class="row">
											<div class="col-xl-12">
												<div class="filter_content">
													<ul class="list-group">
